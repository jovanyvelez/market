...
@router.get("/raiz_activas")
async def listar_categorias_raiz_activas(db: Annotated[Session, Depends(get_session)]):
    """
...
@router.get("/{categoria_id}/productos", response_model=ProductosDescendientesResponse)
